 ...
 * RETURNS: TI_OK or TI_NOK  
 ****************************************************************************/
TI_STATUS cmdBld_CfgConnectionPhase (TI_HANDLE hCmdBld, TMacAddr aMacAddr, TI_UINT32 uMode, void *fCb, TI_HANDLE hCb)
{
	return cmdBld_CfgIeConnectPhase (hCmdBld, aMacAddr, uMode, fCb, hCb);
}
